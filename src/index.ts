...
export interface DetectContext {
  ...
  stdoutIsTTY?: boolean | null | undefined;
  platform?: string | undefined;
  force?: boolean | undefined;
}

function getGlobalProcessLike() {
  const g: any = (typeof globalThis !== "undefined" ? globalThis : {}) as any;
  return typeof g.process === "object" ? g.process : undefined;
}

export function detectColorSupport(ctx: DetectContext = {}): boolean {
...
function makeFormatter(open: string, close: string, replace = open): Formatter {
